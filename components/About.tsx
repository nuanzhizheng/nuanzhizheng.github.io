    ...
    <div className="main-content">
      <div className="content-text">
        ...
        <p>
          ...
          Here and Now Festival in 2021, and was published in Traces, an
          anthology of four Asian plays in Aotearoa (Playmarket, 2025). Their
          other plays include Chick Habit (2023) and Evening! with Jimmy
          Applause (2021). Nuanzhi was part of Auckland Theatre Company’s
        ...
        <p>
          In their practice outside theatre, Nuanzhi exhibited video
          installation work Like an addiction I wept for the place I could not
          access with Gus Fisher Gallery in 2020 and exhibited as part of the
          Estuary Art Award in 2021. Their collaboration with FANG magazine won
          Judge’s Wildcard for Best Overall Zine at Auckland Zinefest 2026.
          Their other work has been published by The Pantograph Punch, Going
          Down Swinging, bad apple, Rat World and Eel Mag.
        </p>
        <p>Nuanzhi on the web:</p>
        <p>
          <a
          ...
          <a
            ...
            className="contact-link"
          >
            Like an addiction I wept for the place I could not access, Gus
            Fisher Gallery, 2020{' '}
          </a>
        </p>
        <p>Theatre:</p>
        <p>
          <a
            href="https://www.pantograph-punch.com/posts/chick-habit"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-link"
          >
            Chick Habit - Interview{' '}
          </a>
          <br />
          <a
            href="https://www.pantograph-punch.com/posts/yang-young"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-link"
          >
          ...
          <br />
          <a
            href="https://thespinoff.co.nz/society/24-07-2021/your-queer-chinese-new-zealand-teenage-fantasy-how-we-wrote-yang-young-%e6%9d%a8"
            target="_blank"
            rel="noopener noreferrer"
            className="contact-link"
          >
      ...
      <div className="content-image">
        <div style={{ position: 'relative', width: 'fit-content' }}>
          ...
          />
          <p className="photo-credit">Photo: Megan Goldsman</p>
        </div>
      </div>
    </div>
  )
